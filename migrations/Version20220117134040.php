 ...
 */
final class Version20220117134040 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE club ADD skatepark_id INT DEFAULT NULL, ADD area VARCHAR(255) NOT NULL, ADD cover_filename VARCHAR(255) DEFAULT NULL, CHANGE zippcode zippcode INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE club DROP skatepark_id, DROP area, DROP cover_filename, CHANGE zippcode zippcode VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
