...
class PageController extends AbstractController
{
     ...
     * @Route("/", name="home")
     */
    public function home(SkateparkRepository $skateparkRepository, ClubRepository $clubRepository, ShopRepository $shopRepository, SessionRepository $sessionRepository)
    {
